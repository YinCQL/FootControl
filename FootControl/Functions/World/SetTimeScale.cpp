...
namespace cheat {
	static void Global_Update_timescale_Hook(void* __this);
	...
	SetTimeScale::SetTimeScale() {
		...
		HookManager::install(app::GameApp_Update, Global_Update_timescale_Hook);
	...
	void Global_Update_timescale_Hook(void* __this) {
