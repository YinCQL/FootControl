...
struct __declspec(align(8)) Dictionary_2_System_String_System_Int32___Fields {
    ...
    struct Dictionary_2_TKey_TValue_Entry_System_String_System_Int32___Array* _entries;
    int32_t _count;
    int32_t _freeList;
    int32_t _freeCount;
    int32_t _version;
    struct IEqualityComparer_1_System_String_* _comparer;
    struct Dictionary_2_TKey_TValue_KeyCollection_System_String_System_Int32_* _keys;
    struct Dictionary_2_TKey_TValue_ValueCollection_System_String_System_Int32_* _values;
...
struct __declspec(align(8)) Dictionary_2_TKey_TValue_KeyCollection_System_String_System_Int32___Fields {
    struct Dictionary_2_System_String_System_Int32_* _dictionary;
};
...
struct __declspec(align(8)) Component_1__Fields {
    struct UnknownFieldSet* _unknownFields;
    uint64_t componentId_;

    int32_t type_;
    struct Object* content_;
    int32_t contentCase_;
...
struct Component_1__VTable {
    ...
    VirtualInvokeData MergeFrom;
    VirtualInvokeData MergeFrom_1;
    VirtualInvokeData WriteTo;
    VirtualInvokeData CalculateSize;
    VirtualInvokeData pb__Google_Protobuf_IMessage_get_Descriptor;
    VirtualInvokeData Equals_1;
    VirtualInvokeData Clone;
    VirtualInvokeData pb__Google_Protobuf_IBufferMessage_InternalMergeFrom;
    VirtualInvokeData pb__Google_Protobuf_IBufferMessage_InternalWriteTo;
};

struct Component_1__StaticFields {
    struct MessageParser_1_Beyond_FactoryCore_Proto_Component_* _parser;
};
...
//struct AbilitySystem__Fields {
//    struct TickComponent__Fields _;
//    struct Buff_BuffContainer* m_buffContainer;
//    struct AbilitySystem_ActionContainer* m_actionContainer;
//    struct Attributes* m_attributes;
//    struct AbilitySystem_SyncedValue_1_System_Double_ m_hp;
//    double m_cachedServerHp;
//    float m_ap;
//    float m_ultimateSp;
//    struct MultiAction_1_Beyond_Gameplay_Core_AbilitySystem_* m_onResetAction;
//    struct EventDispatcher_1_Beyond_Gameplay_Core_AbilitySystem_Event_* m_eventDispatcher;
//    struct PeriodicTimer* m_attackCooldownTimer;
//    struct PeriodicTimer* m_switchCenterTimer;
//    float m_startAttackCdTime;
//    bool m_invokeCastEndCallback;
//    struct Dictionary_2_System_String_Beyond_Gameplay_Core_ModeData_* m_allModes;
//    struct AbilitySystemPatchData* m_patchData;
//    struct ListSet_1_ObjectPtr_1_Beyond_Gameplay_Core_AbilitySystem_* m_children;
//    struct Action* m_modifySkillListAction;
//    struct Action* m_postSkillTickAction;
//    struct MultiAction_1_Beyond_Gameplay_Core_AbilitySystem_* m_onFinish;
//    struct List_1_Beyond_Gameplay_Core_SkillData_* m_skillDataList;
//    struct List_1_UnityEngine_Collider_* m_battleShapeColliders;
//    struct Nullable_1_Beyond_GEnums_AttributeType_ _mainAttributeType_k__BackingField;
//    struct Nullable_1_Beyond_GEnums_AttributeType_ _subAttributeType_k__BackingField;
//    struct Nullable_1_Beyond_GEnums_ProfessionCategory_ _profession_k__BackingField;
//    struct AbilitySystemData* _data_k__BackingField;
//    struct SkillDataBundle* m_skillDataBundle;
//    struct List_1_Beyond_Gameplay_Core_Skill_* m_skills;
//    struct Dictionary_2_System_String_Beyond_Gameplay_Core_Skill_* m_activeSkillMap;
//    bool m_isCastingSkillStart;
//    struct TargetHandle* _selfTargetHandle_k__BackingField;
//    bool _moveInterruptAttack_k__BackingField;
//    bool m_enableMoveStop;
//    bool m_forceDisableMoveStop;
//    struct ObjectPtr_1_Beyond_Gameplay_Core_AbilitySystem_ _source_k__BackingField;
//    struct Blackboard* _sourceBlackboard_k__BackingField;
//    struct ObjectPtr_1_Beyond_Gameplay_Core_IActionEnvironment_ _sourceEnvironment_k__BackingField;
//    struct AbilitySystem_AttackComboConfig _curNormalAttackComboConfig_k__BackingField;
//    struct List_1_System_String_* _curBreakingAttackList_k__BackingField;
//    struct String* _curNormalSkill_k__BackingField;
//    struct List_1_System_String_* _curSkillList_k__BackingField;
//    struct String* _curUltimateSkill_k__BackingField;
//    struct String* _plungingAttackStart_k__BackingField;
//    struct String* _plungingAttackEnd_k__BackingField;
//    struct String* _dodgeSkill_k__BackingField;
//    bool _showBigHeadBar_k__BackingField;
//    bool alreadySendDieOp;
//    struct List_1_System_String_* _curExtraPassiveSkill_k__BackingField;
//    struct MultiAction_2_Beyond_Gameplay_Core_Entity_System_Double_* _onHpChange_k__BackingField;
//    struct MultiAction_1_Beyond_Gameplay_Core_Entity_* _onForceSetHp_k__BackingField;
//    struct MultiAction_2_Beyond_Gameplay_Core_Entity_Beyond_Gameplay_Core_AbilitySystem_Modifier_* _onTakeDamage_k__BackingField;
//    struct MultiAction_1_Beyond_Gameplay_Core_Entity_* _onLvChange_k__BackingField;
//    struct MultiAction_3_Beyond_Gameplay_Core_Entity_System_Single_System_Boolean_* _onPoiseChange_k__BackingField;
//    struct MultiAction_1_Beyond_Gameplay_Core_Entity_* _onUspChange_k__BackingField;
//    struct MultiAction_2_ObjectPtr_1_Beyond_Gameplay_Core_Buff_System_Boolean_* _onBuffIconChange_k__BackingField;
//    struct MultiAction_1_ObjectPtr_1_Beyond_Gameplay_Core_Buff_* _onBuffIgnite_k__BackingField;
//    struct MultiAction* _onPhysicalStatusApply_k__BackingField;
//    struct PeriodicTimer* m_mainCharacterAttackedTimer;
//    struct Skill* _curSkill_k__BackingField;
//    struct AbilitySystem_ComboController* m_comboController;
//    struct ObjectPtr_1_Beyond_Gameplay_Core_AbilitySystem_ m_lastBreakingAttackTarget;
//    struct List_1_Beyond_Gameplay_Core_Skill_* m_equipSkillList;
//    struct Dictionary_2_System_String_List_1_Beyond_Gameplay_Core_AbilitySystem_ModeHandle_* m_enabledModes;
//    struct Dictionary_2_System_String_System_String_* m_realEffectedModes;
//    struct Dictionary_2_System_String_System_Boolean_* m_modeAnimBool;
//    struct List_1_System_String_* m_modeAnimBoolNameList;
//    struct Nullable_1_Single_ _rotateSpeed_k__BackingField;
//    struct ListSet_1_Beyond_Gameplay_Core_DamageModifier_* m_damageModifiers;
//    struct ListSet_1_Beyond_Gameplay_Core_HealModifier_* m_healModifiers;
//    struct ListSet_1_Beyond_Gameplay_Core_PoiseModifier_* m_poiseModifiers;
//    struct Dictionary_2_System_Int32_Beyond_Gameplay_DamageDecorateMask_* m_allowedDamageMasks;
//    struct Nullable_1_Beyond_Gameplay_DamageDecorateMask_ m_allowedDamageMask;
//    float m_poise;
//    struct AbilitySystem_PoiseController* m_poiseController;
//    struct List_1_Beyond_Gameplay_Core_Skill_* _potentialAttachedSkills_k__BackingField;
//    struct List_1_Beyond_Gameplay_Core_AbilitySystem_FrameSplitInitSkillParam_* m_pendingInitSkills;
//    int32_t m_superArmor;
//    struct Dictionary_2_System_Int32_System_Int32_* m_superArmorMap;
//    int32_t m_initialSuperArmor;
//    int32_t m_zeroPoiseSuperArmor;
//    struct AbilitySystem_TacticalItem* m_tacticalItem;
//    struct Dictionary_2_System_String_List_1_Beyond_ObjectPtr_1_* m_appliedItemBuffs;
//    bool m_isInTacItemCastTargetCd;
//    struct PeriodicTimer* m_tacItemCastTargetCdTimer;
//    bool m_isPlayingTacItemToSelfEffect;
//    struct PeriodicTimer* m_tacItemToSelfEffectTimer;
//    struct ItemUseData m_toSelfUseItemData;
//    struct List_1_Beyond_Gameplay_Core_Skill_* _talentAttachedSkills_k__BackingField;
//    struct List_1_Beyond_Gameplay_Core_Skill_* m_weaponSkillList;
//    struct Nullable_1_Beyond_GEnums_WeaponType_ _weaponType_k__BackingField;
//};
//
//struct AbilitySystem {
//    struct AbilitySystem__Class* klass;
//    MonitorData* monitor;
//    struct AbilitySystem__Fields fields;
//};
//
//struct AbilitySystem__StaticFields {
//    //struct ProfilerMarker s_initSkillsMarker;
//    //struct ProfilerMarker s_initPoiseMarker;
//    //struct ProfilerMarker s_initModesMarker;
//    //struct ProfilerMarker s_initSuperArmorMarker;
//    //struct ProfilerMarker s_hpChangeEventMarker;
//    //struct ProfilerMarker s_takeDamageEventMarker;
//    //struct ProfilerMarker s_buffTickMarker;
//    //struct ProfilerMarker s_actionTickMarker;
//    //struct ProfilerMarker s_hpRecoveryMarker;
//    //struct ProfilerMarker s_createSkillMarker;
//    //int32_t s_allowedDamageMaskKeyCounter;
//    //int32_t s_currentSuperArmorKey;
//};
//
//struct AbilitySystem__Class {
//    Il2CppClass_0 _0;
//    Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
//    struct AbilitySystem__StaticFields* static_fields;
//    const Il2CppRGCTXData* rgctx_data;
//    Il2CppClass_1 _1;
//    struct AbilitySystem__VTable vtable;
//};
//
//struct BattleNormalEffect__Fields {
//    //struct EffectInstance__Fields _;
//    //struct ObjectPtr_1_Beyond_Gameplay_Core_AbilitySystem_ m_target;
//    //struct ObjectPtr_1_Beyond_Gameplay_Core_Entity_ m_source;
//};
//
//struct BattleNormalEffect {
//    struct BattleNormalEffect__Class* klass;
//    MonitorData* monitor;
//    struct BattleNormalEffect__Fields fields;
//};
//
//struct BattleNormalEffect__StaticFields {
//};
//
//struct BattleNormalEffect__Class {
//    Il2CppClass_0 _0;
//    Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
//    struct BattleNormalEffect__StaticFields* static_fields;
//    const Il2CppRGCTXData* rgctx_data;
//    Il2CppClass_1 _1;
//    struct BattleNormalEffect__VTable vtable;
//};
enum EEntityType__Enum {
    EEntityType__Enum_All = 0x00000000,
    EEntityType__Enum_Enemy = 0x00000001,
    EEntityType__Enum_Interactive = 0x00000002,
    EEntityType__Enum_Npc = 0x00000003,
    EEntityType__Enum_Character = 0x00000004,
};


struct __declspec(align(8)) Entity__Fields {
    struct IEnumerable_1_Beyond_Gameplay_Core_TagHandle_* m_tagHandle;
    struct app:: String* _name_k__BackingField;
    uint32_t _instanceUid_k__BackingField;
    uint32_t geoHash;
    uint32_t geoLayerHash;
    int32_t gridLayer;
    bool _serverCreated_k__BackingField;
    uint64_t _serverId_k__BackingField;
    uint32_t _serverGeneration_k__BackingField;
    int32_t _levelId_k__BackingField;
    uint64_t _parentScriptId_k__BackingField;

    int32_t _objectType_k__BackingField;

    struct GameplayTagContainer* m_tagContainer;
    bool _isHide_k__BackingField;
    bool _isHideNotStarted_k__BackingField;
    bool _isDisabled_k__BackingField;
    bool _isPaused_k__BackingField;
    bool _isPausedNotStarted_k__BackingField;
    bool _markFinished_k__BackingField;
    bool _markDie_k__BackingField;
    bool _markPreStarted_k__BackingField;
    bool _markStarted_k__BackingField;
    struct ParamBlackboard* _properties_k__BackingField;
    struct ComponentContainer* m_comContainer;
    struct EntityTemplateData* _templateData_k__BackingField;
    struct LevelEntityData* _inLevelData_k__BackingField;
    struct EntityServerData* _serverData_k__BackingField;
    struct RootComponent* _rootCom_k__BackingField;
    bool m_ignoreGlobalTimeScale;
    int32_t _ignoreGlobalTimeScaleReason_k__BackingField;
    int32_t m_logicId;
    int32_t _scopeName_k__BackingField;

    struct Action* onEntityStarted;
    bool _inCinematic_k__BackingField;
    struct InitedInterface* _inited_k__BackingField;
    struct UnInitedInterface* _unInited_k__BackingField;
};

struct Entity {
    struct Entity__Class* klass;
    MonitorData* monitor;
    struct app::Entity__Fields fields;
};
struct ObjectPtr_1_Beyond_Gameplay_Core_Entity_ {
    struct Entity* obj;
    uint32_t cachedUid;
};
...
//struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___Class {
//    Il2CppClass_0 _0;
//    Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
//    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___StaticFields* static_fields;
//    const Il2CppRGCTXData* rgctx_data;
//    Il2CppClass_1 _1;
//    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___VTable vtable;
//};

struct __declspec(align(8)) UnorderedArray_1_ObjectPtr_1_Beyond_Gameplay_Core_Entity___Fields {
    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___Array* m_items;
    struct Dictionary_2_Beyond_ObjectPtr_1_System_Int32_* m_itemMap;
    int32_t _count_k__BackingField;
};

struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___Array {
    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___Array__Class* klass;
    MonitorData* monitor;
    Il2CppArrayBounds* bounds;
    il2cpp_array_size_t max_length;
    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity_ vector[32];
};

struct UnorderedArray_1_ObjectPtr_1_Beyond_Gameplay_Core_Entity_ {
    struct UnorderedArray_1_ObjectPtr_1_Beyond_Gameplay_Core_Entity___Class* klass;
    MonitorData* monitor;
    struct UnorderedArray_1_ObjectPtr_1_Beyond_Gameplay_Core_Entity___Fields fields;
};


struct ObjectPtr_1_Beyond_Gameplay_Core_IHittableObject_ {
    struct IHittableObject* obj;
    uint32_t cachedUid;
};

struct BattleHitReactionManager_HitInfo {
    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity_ attacker;
    struct ObjectPtr_1_Beyond_Gameplay_Core_IHittableObject_ hitTarget;
    struct Vector3 hitPoint;
    struct String* hitMethodId;
    float hitValue;
    bool dontHitImportInteractive;
};
enum ObjectType__Enum {
...
struct __declspec(align(8)) SC_SYNC_STAMINA__Fields {
    struct UnknownFieldSet* _unknownFields;
    uint32_t curStamina_;
    uint32_t maxStamina_;
    int64_t nextRecoverTime_;
    int32_t delta_;
};

struct SC_SYNC_STAMINA {
    struct SC_SYNC_STAMINA__Class* klass;
    MonitorData* monitor;
    struct SC_SYNC_STAMINA__Fields fields;
};
enum EnemyAIModeType__Enum {
    EnemyAIModeType__Enum_None = 0x00000000,
    EnemyAIModeType__Enum_Idle = 0x00000001,
    EnemyAIModeType__Enum_Patrol = 0x00000002,
    EnemyAIModeType__Enum_Vigilance = 0x00000003,
    EnemyAIModeType__Enum_Battle = 0x00000004,
    EnemyAIModeType__Enum_LeaveBattle = 0x00000005,
    EnemyAIModeType__Enum_Born = 0x00000006,
    EnemyAIModeType__Enum_Atmospheric = 0x00000007,
    EnemyAIModeType__Enum_AttackBuilding = 0x00000008,
};


struct GameWorld__Fields {
   void* /*structBaseManager__Fields */ _;
    bool _isAllEnemiesActive_k__BackingField;
    struct String* _curMapIdStr_k__BackingField;
    int32_t _curMapId_k__BackingField;
    struct GameLevel* _curLevel_k__BackingField;
    struct BaseGameScene* _curScene_k__BackingField;
    bool _isStarted_k__BackingField;
    struct Action* levelStartCallback;
    struct Action* worldStartCallbackOnce;
    struct Action* worldReadyCallbackOnce;
    struct ParamBlackboard* _globalBlackboard_k__BackingField;
    bool _inFactoryMode_k__BackingField;
    bool m_inMainHud;
    bool m_inGacha;
    struct GameWorld_WorldManagerCollection* m_worldManagers;
    struct Dictionary_2_System_Int32_Beyond_Gameplay_Core_GameLevel_* m_levels;
    bool _IsReleasingWorld_k__BackingField;
    struct List_1_Beyond_Gameplay_Core_SelfTimeScaleHandle_* m_pausedEntityTimeScaleHandles;
    float _timeScale_k__BackingField;
    bool _ignoreGlobalTimeScale_k__BackingField;
    struct GameWorld_ObjectContainer* m_objectContainer;
    struct EntityManager* _entityManager_k__BackingField;
    struct LegacyEntityManager* _legacyEntityManager_k__BackingField;
    struct EntityAllocator* _entityAllocator_k__BackingField;
    struct EntityCreator* _entityCreator_k__BackingField;
};
...
struct GameWorld__VTable {
    ...
    VirtualInvokeData InternalInit;
    VirtualInvokeData OnInit;
    VirtualInvokeData InternalRelease;
    VirtualInvokeData OnRelease;
    VirtualInvokeData get_timeScale;
    VirtualInvokeData get_ignoreGlobalTimeScale;
    VirtualInvokeData set_ignoreGlobalTimeScale;
    VirtualInvokeData AttachTickChild;
    VirtualInvokeData DetachTickChild;
    VirtualInvokeData OnTimeScaleChange;
};

struct GameWorld__StaticFields {
    struct List_1_Beyond_ObjectPtr_1__4* s_spawnedEntityList;
    struct List_1_Beyond_Gameplay_Core_GameWorld_SpawnDelayMask_* s_spawnedEntityDelayToStartList;
    struct List_1_Beyond_Gameplay_Core_GameWorld_EnemySpawnData_* s_enemySpawnDataList;
    struct List_1_Beyond_Gameplay_Core_GameWorld_InteractiveSpawnData_* s_interactiveSpawnDataList;
    struct List_1_Beyond_Gameplay_Core_GameWorld_NpcSpawnData_* s_npcSpawnDataList;
};

struct GameWorld__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
    struct GameWorld__StaticFields* static_fields;
    const Il2CppRGCTXData* rgctx_data;
    Il2CppClass_1 _1;
    struct GameWorld__VTable vtable;
};

struct __declspec(align(8)) List_1_Beyond_ObjectPtr_1__4__Fields {
    struct ObjectPtr_1_Beyond_Gameplay_Core_Entity___Array* _items;
    int32_t _size;
    int32_t _version;
    struct Object* _syncRoot;
};
struct List_1_Beyond_ObjectPtr_1__4 {
